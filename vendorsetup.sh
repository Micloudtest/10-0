...
if [ -f "$(gettop)/bootable/recovery/orangefox.cpp" ]; then
	echo -e "\x1b[96m[INFO]: Setting up OrangeFox build vars for garden...\x1b[m"
    ...
    export FOX_VARIANT="Stable"
		export FOX_BUILD_TYPE="Unofficial"
	 	export FOX_TARGET_DEVICES="blossom,angelica,angelicain,angelican,cattail,dandelion,garden"
		export TARGET_DEVICE_ALT="blossom,angelica,angelicain,angelican,cattail,dandelion,garden"
		export LC_ALL="C"
		...
		export OF_FL_PATH1="/tmp/flashlight" # See /init.mt6765.rc for more information
